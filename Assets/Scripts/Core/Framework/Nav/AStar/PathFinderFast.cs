...
namespace Core.Framework.Nav.AStar
{
    public class PathFinderFast : IPathFinder
    {
        ...
        public List<PathFinderNode> FindPath(Vector2Int start, Vector2Int end, int nSearchLimit)
        {
        ...
        public static bool hasBarrier(ref byte[,] grid, int startX, int startY, int endX, int endY)
        {
            ...
            Vector2 point1 = new Vector2(startX + 0.5f, startY + 0.5f);
            Vector2 point2 = new Vector2(endX + 0.5f, endY + 0.5f);
