...
public static class ExampleConfig
{
   ...
   // private static List<string> namespaces = new List<string>() // 在这里添加名字空间
   //         {
   //             //"UnityEngine",
   //             //"UnityEngine.UI"
   //             "Facebook"
   //         };
   // private static bool checkNamespace(string namesapce)
   // {
   //     foreach(var n in namespaces)
   //     {
   //         if (namesapce.StartsWith(n) && !namesapce.Contains("Editor"))
   //             return true;
   //     }
   //     return false;
   // }
   ...
   //                           where type.Namespace != null && checkNamespace(type.Namespace)/*namespaces.Contains(type.Namespace)*/ && !isExcluded(type)
