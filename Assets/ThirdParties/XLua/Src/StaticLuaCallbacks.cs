...
namespace XLua
{
    ...
    public partial class StaticLuaCallbacks
    {
        ...
        [MonoPInvokeCallback(typeof(LuaCSFunction))]
        public static int XLuaIsNull(RealStatePtr L)
        {
            try
            {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                UnityEngine.Object obj = (UnityEngine.Object)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, obj as object == null || obj == null);
                return 1;
            }
            catch (Exception e)
            {
